...
export class CreateofferComponent implements OnInit {
    ...
    public sendInput() {
        ...
        this.api
            .post('/api/offers', {
                startAddress:
                    this.checkoutForm.value.startZip +
                    ' ' +
                    this.checkoutForm.value.startCity +
                    ' ' +
                    this.checkoutForm.value.startCountry,
                destAddress:
                    this.checkoutForm.value.destZip +
                    ' ' +
                    this.checkoutForm.value.destCity +
                    ' ' +
                    this.checkoutForm.value.destCountry,
